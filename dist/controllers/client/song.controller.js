...
const like_song_model_1 = __importDefault(require("../../models/like-song.model"));
...
const detail = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const likeSong = yield like_song_model_1.default.findOne({
        songId: song.id
    });
...
const like = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    switch (typeLike) {
        case "like":
            const existLikeSong = yield like_song_model_1.default.findOne({
                songId: idSong
            });
            if (!existLikeSong && user != null) {
                const record = new like_song_model_1.default({
                    userId: user._id,
                    songId: idSong
                });
                yield record.save();
            ...
            break;
        case "dislike":
            yield like_song_model_1.default.deleteOne({
                songId: idSong
            });
            break;
        default:
